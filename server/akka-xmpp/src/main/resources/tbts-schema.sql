...
CREATE TABLE expleague.Devices (
  id VARCHAR(64),
  user VARCHAR(64),
  token VARCHAR(256),
  passwd VARCHAR(128),
...
CREATE TABLE expleague.Participants (
  id INTEGER(32) AUTO_INCREMENT,
