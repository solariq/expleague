 ...
 * Time: 22:31
 */
public class TrackPresenceComponentClustered extends SessionManagerClustered {
  private static final Logger log = Logger.getLogger(TrackPresenceComponentClustered.class.getName());
  private static Criteria CRIT = ElementCriteria.name("presence");
  private ExpertsAdminBot adminBot;

  public TrackPresenceComponentClustered() {
    super();
  }
