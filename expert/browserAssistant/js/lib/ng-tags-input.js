...
(function () {
     ...
     */
    tagsInput.directive('tagsInput', ["$timeout", "$document", "tagsInputConfig", "$sce", function ($timeout, $document, tagsInputConfig, $sce) {
        ...
        return {
            ...
            replace: false,
            transclude: true,
            templateUrl: $sce.trustAsResourceUrl('ngTagsInput/tags-input.html'),
