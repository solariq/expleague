...
public:
    ...
    virtual void OnCursorChange(CefRefPtr<CefBrowser> browser, HCURSOR cursor, CursorType type, const CefCursorInfo &custom_cursor_info);
...
public:
    ...
    Q_INVOKABLE bool sendKeyPress(int key, Qt::KeyboardModifiers modifiers, const QString& tex, bool autoRepeat, ushort count);
    Q_INVOKABLE bool sendKeyRelease(int key, Qt::KeyboardModifiers modifiers, const QString& tex, bool autoRepeat, ushort count);
...
class BrowserListener: public CefRequestHandler, public CefLifeSpanHandler, public CefDisplayHandler,
        public CefKeyboardHandler, public CefDragHandler, public CefLoadHandler, public CefDownloadHandler,
