...
Q_OBJECT
  ...
  Q_PROPERTY(QUrl avatar
                     ...
                     NOTIFY
                     avatarChanged)
  Q_PROPERTY(QQmlListProperty<expleague::RoomStatus> history
                     READ
                     historyQml
                     NOTIFY
                     historyChanged)
  Q_PROPERTY(expleague::Member::Status status
                     READ
                     status
                     NOTIFY
                     statusChanged)
...
public:
  ...
  QQmlListProperty<RoomStatus> historyQml() const {
    return QQmlListProperty<RoomStatus>(const_cast<Member *>(this), const_cast<QList<RoomStatus *> &>(m_history));
  }
...
public:
  TaskTag(const QString &name = "", const QUrl &icon = QUrl("qrc:/avatar.png"), QObject *parent = 0) : QObject(parent),
                                                                                                       m_name(name),
                                                                                                       m_icon(icon) {}
...
public:
  AnswerPattern(const QString &name = "", const QUrl &icon = QUrl("qrc:/avatar.png"), const QString &text = "",
                QObject *parent = 0) : QObject(parent), m_name(name), m_icon(icon), m_text(text) {}
...
Q_OBJECT
  ...
  Q_PROPERTY(expleague::League::Status status
                     READ
                     status
                     NOTIFY
                     statusChanged)
  Q_PROPERTY(expleague::League::Role role
                     READ
                     role
                     NOTIFY
                     roleChanged)

  Q_PROPERTY(expleague::Profile *profile
                     READ
                     active
                     WRITE
                     setActive
                     NOTIFY
                     profileChanged)
  Q_PROPERTY(QQmlListProperty<expleague::Profile> profiles
                     READ
                     profiles
                     NOTIFY
                     profilesChanged)
  Q_PROPERTY(QQmlListProperty<expleague::TaskTag> tags
                     READ
                     tags
                     NOTIFY
                     tagsChanged)
  Q_PROPERTY(QQmlListProperty<expleague::AnswerPattern> patterns
                     READ
                     patterns
                     NOTIFY
                     patternsChanged)
  Q_PROPERTY(QStringList helloPatterns
                     READ
                     helloPatterns
                     NOTIFY
                     chatPatternsChanged)
  Q_PROPERTY(QStringList chatPatterns
                     READ
                     chatPatterns
                     NOTIFY
                     chatPatternsChanged)
  Q_PROPERTY(QStringList experts
                     READ
                     experts
                     NOTIFY
                     membersChanged)
  Q_PROPERTY(expleague::GlobalChat *chat
                     READ
                     chat
                     CONSTANT)
