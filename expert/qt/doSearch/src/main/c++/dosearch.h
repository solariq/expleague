...
Q_OBJECT
  ...
  Q_PROPERTY(expleague::DownloadManager* downloadManager READ downloadManager CONSTANT)
...
public:
  ...
  DownloadManager* downloadManager() const{ return m_download_manger;}
...
private:
  ...
  DownloadManager* m_download_manger;
  History* m_history;
