        ...
        messages: [
          {
            type: 'client',
            title: 'Необходимо найти',
            text: 'Правила парковки в Финляндии, срочность поиска: в течение дня, необходима помощь эксперта',
            timestamp: null
          },
          {
            type: 'server',
        ...
        messages: [
          {
            type: 'client',
            title: 'Необходимо найти',
            text: 'круглосуточная аптека рядом с адресом: Москва, ул. Большая Декабрьска 10, срочность поиска: в течение минуты',
            timestamp: null
          },
          {
            type: 'server',
