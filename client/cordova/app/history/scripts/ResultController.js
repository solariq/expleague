angular
  ...
  .controller('ResultController', function($scope, supersonic) {
    ...
    window.ordersHistory = [
        ...
        messages: [
          {
            ...
            text: 'Самый большой по площади парк Питера<br> срочность поиска: пол часа',
            timestamp: null
          },
          {
            type: 'server',
      ...
      {
        id: 1,
        text: 'Правила парковки в Финляндии<br> срочность поиска: в течение дня<br>необходима помощь эксперта',
        near: false,
        expert: false,
        urgency: 0, // От 0 до 5
        ...
        messages: [
          ...
          },
          {
            type: 'server',
            title: 'Поиск исполнителя',
            text: 'Эксперт найден. Владимир, 4 года живет в Хельсинки. Вы получите уведомление, когда исполнитель найдет необходимую информацию.',
            timestamp: null
          },
          {
            type: 'server',
