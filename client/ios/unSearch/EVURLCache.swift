...
public class EVURLCache : NSURLCache {
    ...
    public static var MAX_CACHE_SIZE = 31 // The maximum file size that will be cached (2^30 = 256MB)
    ...
    public static func storeCachedResponse(cachedResponse: NSCachedURLResponse, forRequest request: NSURLRequest) {
